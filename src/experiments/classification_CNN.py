...
if __name__ == '__main__':
    ...
    model_weights = '../../Data/region_classification/output/aurora256_iter_10000.caffemodel'
    meanFile = '../../Data/region_classification/output/imgMean38044.npy'
    net = caffe.Net(model_def, model_weights, caffe.TEST)
    transformer = caffe.io.Transformer({'data': net.blobs['data'].data.shape})
    transformer.set_raw_scale('data', 255)
    net.blobs['data'].reshape(10, 1, imSize, imSize)
    # im = imread(imgFile)
    ...
    result_cls = 'result_classification_CNN_nofinetune.txt'
    classNum = 4
